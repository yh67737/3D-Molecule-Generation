...
def get_args_parser():
    ...
    #parser.add_argument('--fragment_data_dir', type=str, default='./prepared_data/32for_test',help='Directory containing some JSON fragment files.')  ###
    parser.add_argument('--fragment_data_dir', type=str, default='./prepared_data/gdb9_unique_subgraphs_json', help='Directory containing the JSON fragment files.')
